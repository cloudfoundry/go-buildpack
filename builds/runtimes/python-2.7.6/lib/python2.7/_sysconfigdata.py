...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BINLIBDEST': '/tmp/python/lib/python2.7',
 ...
 'CONFIG_ARGS': "'--prefix' '/tmp/python'",
 'CONFINCLUDEDIR': '/tmp/python/include',
 'CONFINCLUDEPY': '/tmp/python/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++ -pthread',
 'C_THREADS': 0,
 'DESTDIRS': '/tmp/python /tmp/python/lib /tmp/python/lib/python2.7 /tmp/python/lib/python2.7/lib-dynload',
 'DESTLIB': '/tmp/python/lib/python2.7',
 'DESTPATH': '',
 'DESTSHARED': '/tmp/python/lib/python2.7/lib-dynload',
 'DIRMODE': 755,
 ...
 'HURD_C_THREADS': 0,
 'INCLDIRSTOMAKE': '/tmp/python/include /tmp/python/include /tmp/python/include/python2.7 /tmp/python/include/python2.7',
 'INCLUDEDIR': '/tmp/python/include',
 'INCLUDEPY': '/tmp/python/include/python2.7',
 ...
 'LIBC': '',
 'LIBDEST': '/tmp/python/lib/python2.7',
 'LIBDIR': '/tmp/python/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBP': '/tmp/python/lib/python2.7',
 'LIBPC': '/tmp/python/lib/pkgconfig',
 'LIBPL': '/tmp/python/lib/python2.7/config',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmp/python/lib/python2.7',
 'MACH_C_THREADS': 0,
 ...
 'abs_builddir': '/var/vcap/data/warden/depot/17t1v85pqat/tmp/rootfs/home/vcap/app/vendor/heroku/heroku-buildpack-php/builds/src/Python-2.7.6',
 'abs_srcdir': '/var/vcap/data/warden/depot/17t1v85pqat/tmp/rootfs/home/vcap/app/vendor/heroku/heroku-buildpack-php/builds/src/Python-2.7.6',
