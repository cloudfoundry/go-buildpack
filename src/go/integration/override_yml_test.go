...
var _ = Describe("override yml", func() {
	...
	It("Forces go from override buildpack", func() {
		...
		Eventually(app.Stdout.String).Should(ContainSubstring("Error installing Go: dependency sha256 mismatch: expected sha256 062d906c87839d03b243e2821e10653c89b4c92878bfe2bf995dec231e117bfc, actual sha256 b56b58ac21f9f42d032e1e4b8bf8b8823e69af5411caa15aee2b140bc756962f"))
	})
})
